        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-4">
                <div class="p-6 text-gray-900">
                    <h1 class="text-center font-extrabold text-2xl mb-2">Form Tambah Ruang Istirahat</h1>
                    <form method="POST" action="{{route('restroom.store')}}" class="max-w-xl mx-auto" x-data='sesiForm' x-ref='seForm' enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="grid grid-flow-row grid-cols-2 gap-4">
                            <div class="w-full px-1">
                                ...
                                <input class="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md p-2 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Ruangan 103" type="text" name="name" id="name" />
                            ...
                            <div class="w-full px-1">
                                ...
                                <input class="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md p-2 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="300" type="number" name="capacity" id="capacity" />
                            ...
                            <div class="w-full px-1">
                                ...
                                <div class="grid grid-flow-col gap-2">
                                    <div class="flex items-center">
                                        <input id="grade-radio-1" type="radio" value="Laki-laki" name="gender" class="w-4 h-4 text-pink-600 bg-gray-100 border-gray-300 focus:ring-pink-500 dark:focus:ring-pink-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                        <label for="grade-radio-1" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Laki - Laki</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input id="grade-radio-2" type="radio" value="Perempuan" name="gender" class="w-4 h-4 text-pink-600 bg-gray-100 border-gray-300 focus:ring-pink-500 dark:focus:ring-pink-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
