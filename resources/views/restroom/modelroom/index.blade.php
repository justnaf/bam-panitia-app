    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mx-auto" x-data="eventHandler({{ $events->first()->id ?? 'null' }})" x-init="init()">
                ...
                <a :href="'{{ route('restroom.randomizeDistri') }}?event_id=' + selectedEvent" class="text-green-700 hover:text-white border border-green-700 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                    <input type="text" name="event_id" hidden x-model="selectedEvent">
                    Randomize Kamar Peserta
                </a>
                        ...
                        <table class="w-full text-sm text-left text-gray-500 border border-gray-200">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-100 border-b">
                                <tr>
                                    ...
                                    <th class="px-2 py-3">Jumlah Peserta</th>
                                ...
                                <template x-if="selectedEvent && Array.isArray(data) && data.length > 0">
                                    <template x-for="(room, index) in data" :key="room.id">
                                        <tr>
                                            ...
                                            <td class="p-3">
                                                <p x-text="room.model_has_restroom.length"></p>
                                            </td>
                                            <td class="p-3">
                                                <a :href="'restroom-distribute/'+ room.id+'/edit'" class="hover:text-orange-500">
